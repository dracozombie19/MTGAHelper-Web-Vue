...
<div>
		...
		<div class="box">
				<p>
						This privacy notice discloses the privacy practices for MTGAHelper. This privacy notice
				...
				<p>
						...
						We only have access to/collect information that you voluntarily give us via email or other
				...
				<p>
						You can do the following at any time by <router-link to="/Contact">contacting us</router-link>:
						<ul>
				...
				<p>
						...
						us in a secure way.
						You can verify this by looking for a lock icon in the address bar and looking for "https" at
				...
				<p>
						...
						your information offline.
						Only employees who need the information to perform a specific job (for example, billing or
				...
				<p>
						...
						more than once, thereby saving time while on our site.
						Cookies can also enable us to track and target the interests of our users to enhance the
				...
				<p>
						...
						the content or privacy practices of such other sites.
				...
				<p>
						If you feel that we are not abiding by this privacy policy, you should <router-link to="/Contact">contact us</router-link> immediately.
				</p>
		</div>
</div>
