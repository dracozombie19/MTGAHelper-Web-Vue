<template>
    <div>
        <h4 class="title is-4">
            <i class="fas fa-envelope" /> Leave a message, feedback is appreciated
        </h4>
        ...
        <h6 class="title is-6">
            ...
            <a href="https://discord.gg/GTd3RMd"
                target="_blank">
                Discord server
                <i class="fab fa-discord my-float" style="margin-top:10px;" />
            </a>
        </h6>
        <div class="field">
            <div class="control">
                ...
                <textarea
                    ...
                    rows="12"
                    class="textarea"
                    :class="contactMessage.length === 0 ? 'is-danger' : 'is-success'"/>
            </div>
        </div>
